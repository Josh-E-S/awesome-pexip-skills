...
- `signals-pattern` — `infinityClientSignals.onLiveCaptions` is the source signal
- `branding-manifest` — `applicationConfig.showLiveCaptionsFeature` toggles the whole feature off
