...
- `signals-pattern` — `presentationStreamSignal`, `endPresentationSignal`, `startPresentationSignal`
- `stats-monitoring` — `qualityLimitationReason` often correlates with degraded presentation video
