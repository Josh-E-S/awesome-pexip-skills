...
- `presentation` — `pres_slot_coords` interacts with layout state
- `participants` — `me.canChangeLayout`, `me.canReceivePersonalMix` are participant capability flags
